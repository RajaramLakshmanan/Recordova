...
- (void)getDeeplinkingData: (CDVInvokedUrlCommand *)command {
    ...
    [REiosHandler getDeeplinkingDataWithSuccess:^(NSDictionary<NSString *,id> * dataDict) {
        ...
        NSLog(@"deeplink data error %@",error);
